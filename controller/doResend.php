	...
	if($_FILES['fileUpload']['tmp_name'])
		{
			...
			else
			{
				...
				customname='$customname', status='resend',harga='$price', warna='$warna', image='$picName', keterangan='$keterangan' where customizeID=$customizeID");
		...
		{
		mysql_query("update trcustomize set
				customname='$customname', status='resend',harga='$price', warna='$warna', keterangan='$keterangan' where customizeID=$customizeID");
				mysql_query("update detailcustomize set
				quantity='$quantity', S='$s', M='$m', L='$l', XL='$xl', XXL='$xxl', XXXL='$xxxl' where customizeID=$customizeID");
