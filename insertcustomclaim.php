	...
	<center>
      <img src="images/membersOnly.jpg" class="img-responsive">
          ...
          <?php }else if(($_SESSION['userRole'] == "member")){?>
			<form action="controller/doInsertCustomClaim.php" method="post" enctype="multipart/form-data">
    <table  align="center">
    <tr>
        <td colspan="8"><h2>Insert Your Claim</h2></td>
    </tr>
    <tr>
        <td>Ket Claim</td><td> </td>
        <td colspan="6"><textarea name= "txtKetC"></textarea></td>
    </tr>
       <tr>
        <td>Qty Claim</td><td> </td>
        <td colspan="6"><input type ="text" name = "txtQtyC" style="width:30px;"/></td>
    </tr>
    <tr>
       <td>Claim Image</td>
        <td> </td>
