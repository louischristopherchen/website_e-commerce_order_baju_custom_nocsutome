...
--
-- Inang: 127.0.0.1
-- Waktu pembuatan: 10 Jun 2016 pada 19.18
-- Versi Server: 5.5.27
-- Versi PHP: 5.4.7
...
INSERT INTO `trclaim` (`claimID`, `transactionID`, `quantity_claim`, `ketclaim`, `image_claim`) VALUES
(16, 36, 0, '', ''),
(17, 37, 0, '', ''),
(18, 38, 0, '', ''),
(19, 39, 0, '', ''),
...
INSERT INTO `trpayment` (`paymentID`, `transactionID`, `nama_payment`, `nama_bank`, `nilai_transfer`, `status_payment`) VALUES
(17, 36, '', '', 0, ''),
(18, 37, '', '', 0, ''),
(19, 38, '', '', 0, ''),
(20, 39, '', '', 0, ''),
...
(22, 41, '', '', 0, ''),
(23, 42, '', '', 0, ''),
(24, 43, 'Louis Christopher Chen', 'BCA', 10000000, 'approved'),
(26, 45, 'Louis Christopher Chen', 'BCA', 3000000, 'approved');
